...
# ----------------------
# Radiation pattern 2x2 unit cells (Figure 6(a))
# ----------------------
beta = 1.6
nl = 4;
np = nl^2;
iC4 = findC4(nl,d,beta)
P1 = RadPat(4,d,1.6,iC4)
P1 = plot!(subplot=2, xlims=(-1.25*d,1.25*d),left_margin=3mm, right_margin=3mm)
P1 = plot!(title="(a) 2x2 unit cells", titlefontfamily="Computer Modern", subplot=1)
P1 = plot!(title="(b)", titlefontfamily="Computer Modern", subplot=2)

# ----------------------
# Radiation pattern 10x10 unit cells (Figure 6(c))
# ----------------------
beta = 1.6
nl = 20;
np = nl^2;
...
# ----------------------
# Radiation pattern 20x20 unit cells (Figure 6(e))
# ----------------------
...
# Save figure
# ----------------------
savefig(P, joinpath(results_path, "figure6.png"))
