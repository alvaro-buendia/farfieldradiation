...
# ----------------------
# Radiation pattern 2x2 unit cells (Figure 5(a))
# ----------------------
beta = 1.6
nl = 4;
np = nl^2;
iE1 = findE1(nl,d,beta)
P1 = RadPat(4,d,1.6,iE1)
...
# ----------------------
# Radiation pattern 10x10 unit cells (Figure 5(c))
# ----------------------
beta = 1.6
nl = 20;
np = nl^2;
...
# ----------------------
# Radiation pattern 20x20 unit cells (Figure 5(c))
# ----------------------
...
# Save figure
# ----------------------
savefig(P, joinpath(results_path, "figure5.png"))
