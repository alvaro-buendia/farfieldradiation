...
# ----------------------
# Radiation pattern 1x1 unit cells (Figure 3(c))
# ----------------------
P1 = RadPat(2,d,1.6,1)
...
# ----------------------
# Radiation pattern 10x10 unit cells (Figure 2(c))
# ----------------------

beta = 1.6
nl = 20;
np = nl^2;
iB4 = findB4(nl,d,beta)
P2 = RadPat(nl,d,beta,iB4)
...
# Save figure
# ----------------------
savefig(P, joinpath(results_path, "figure2.png"))
